...
ideFrame::ideFrame(wxWindow* parent,wxWindowID id)
{
    ...
    ToolBarItem6 = ToolBar1->AddTool(TOOL_CONNECT, _("Connect"), wxBitmap(wxImage(_T("icons\\disconnect.png"))), wxNullBitmap, wxITEM_NORMAL, _("Connect to device"), wxEmptyString);
    ToolBarItem7 = ToolBar1->AddTool(TOOL_DOWNLOAD, _("Download"), wxBitmap(wxImage(_T("icons\\arrow_down.png"))), wxNullBitmap, wxITEM_NORMAL, _("Download to device"), wxEmptyString);
    ToolBar1->AddSeparator();
